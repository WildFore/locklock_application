        ...
        bottomNavigationBar: Container(
          ...
          child: ClipRRect(
            ...
            child: NavigationBar(
              ...
              destinations: const [
                NavigationDestination(icon: Icon(Icons.add_rounded, color: Color.fromARGB(255, 235, 235, 235)), selectedIcon: Icon(Icons.add_rounded, color: Color.fromARGB(255, 30, 30, 30), size: 30), label: "Add new device"),
                NavigationDestination(icon: Icon(Icons.home_rounded, color: Color.fromARGB(255, 235, 235, 235)), selectedIcon: Icon(Icons.home_rounded, color: Color.fromARGB(255, 30, 30, 30), size: 30), label: "Home"),
                NavigationDestination(icon: Icon(Icons.settings_rounded, color: Color.fromARGB(255, 235, 235, 235)), selectedIcon: Icon(Icons.settings_rounded, color: Color.fromARGB(255, 30, 30, 30), size: 30,), label: "Settings")
              ],
